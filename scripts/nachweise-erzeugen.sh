...
ARTEFAKTE=(
  ...
  "Selbsttest DoD-Gate|scripts/dod-gate-selbsttest.sh|Formpruefungen gegen eine Attrappe von make dod, dazu ein roter und ein gruener Lauf gegen das echte Makefile (ADR 0002, 6.12.19)"
