...
ARTEFAKTE=(
  ...
  "Gate Definition of Done|.claude/hooks/dod-gate.sh|Laesst Antwort, Subagent und Aufgabe erst enden, wenn make dod nachweisbar gelaufen ist und nichts gefunden hat (Stop, SubagentStop, TaskCompleted; ADR 0002, 6.12; gebaut 2026-09-02 auf Weisung; die Entscheidpunkte E-A bis E-K sind am 2026-09-07 foermlich freigegeben, die Abnahme des Gates ist am 2026-09-08 in Abschnitt 10 vorgelegt und steht aus)"
