...
ARTEFAKTE=(
  ...
  "Pruefmittel PreToolUse-Gates|scripts/pretooluse-gates-selbsttest.sh|Selbsttest der beiden PreToolUse-Gates (R3-Q-010, E4.1): 202 Faelle mit Kennung, Gate, Werkzeug, Eingabe, Soll und Ist gegen einen Wegwerf-Klon auf main und den Arbeitsbaum, Zaehlung je Gate, Fallklassen der Kopfkommentare, belegte Luecken mit Soll = heutiger Stand; Modus --mutationen mit zehn Mutationen und Grundlinie (ADR 0002, 6.13 d)"
