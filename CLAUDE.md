...
| Fremde Inhalte im Harness — E3 (R3-Q-011): Regel (gebaut mit E3.1), Skill zur Einschleusungsprüfung, Prüfsatz, Rollenliste (festgelegt, nicht gebaut), Schnitt E3.1 bis E3.3 | `.claude/rules/fremde-inhalte-im-harness.md` (ohne `paths:`); ADR 0002, 6.14; Backlog-Eintrag R3-Q-011 in `docs/05_Product_Backlog.md`; Begriffe Einschleusung, Fremder Inhalt und Harness in `docs/03_Glossar.md` |
