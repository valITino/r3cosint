...
| Gate | Wirkung |
|---|---|
| `block-prototype-import.sh` | Blockiert Importe zwischen `prototype/` und Produktionscode in beide Richtungen (5.6). Erkennt seit E4.2 (2026-09-23) auch den Verzeichnisimport ohne Schrägstrich, den Rückstrich-Pfad, den Präfix `./` sowie HTML- und Python-Formen in Richtung 2; die Meldung nennt 5.6 und die Richtung. Seit E4.3 (2026-09-23) auch die Schreibwirkung eines Interpreters mit Inline-Code (dieselbe Befehlsklasse wie das main-Gate) und eine nicht auswertbare Eingabe (Rückgabewert 2); die Nichtprüfung gemeinsamer Abhängigkeiten ist als Grenze benannt. Prüfmittel: `scripts/pretooluse-gates-selbsttest.sh` (R3-Q-010; keine belegte Lücke aus den sieben Abnahmekriterien von R3-Q-010 verbleibt; die Prüfstand-Fälle laufen mit heutigem Wert und sind seit dem 2026-09-23 in ADR 0002, 6.13 c entschieden: L05 bis L09 als belegte Lücken in den Posten 2 und 3 unter R3-Q-010, terminiert mit der nächsten Änderung an den Gates, ZF10d und L10 bis L16 als Grenze, ZF9 und ZF10c als gewollt; abgenommen am 2026-09-23 durch Merge des Pull Requests #21, ADR 0002, Abschnitt 10) |
| `block-main-write.sh` | Blockiert Dateiänderungen auf `main` sowie Commit, Merge und Push nach `main` (3.2 c). Seit E4.3 (2026-09-23) blockiert es auch eine nicht auswertbare Eingabe (Rückgabewert 2, ADR 0002, 6.13 b); Grenze bleibt der untergeordnete Shell-Aufruf, eine Subshell in Klammern wird erkannt. Prüfmittel: `scripts/pretooluse-gates-selbsttest.sh` (R3-Q-010; ST-01 bis ST-03 fremdbelegt; die Prüfstand-Fälle laufen mit heutigem Wert und sind seit dem 2026-09-23 in ADR 0002, 6.13 c entschieden: L01 bis L04 als belegte Lücken in Posten 1 unter R3-Q-010, terminiert mit der nächsten Änderung an den Gates, ZF10a und ZF10b als Grenze; abgenommen am 2026-09-23 durch Merge des Pull Requests #21, ADR 0002, Abschnitt 10) |
...
| Prüfmittel der beiden PreToolUse-Gates (Fallliste, Mutationsmodus `--mutationen`) | `scripts/pretooluse-gates-selbsttest.sh`; Festlegung in ADR 0002, 6.13 d, Bau in 6.13 (Nachtrag vom 2026-09-23); Abnahme in ADR 0002, Abschnitt 10; Prüfstand-Fälle in ADR 0002, 6.13 c (Nachtrag vom 2026-09-23) |
...
| Fremde Inhalte im Harness — E3 (R3-Q-011): Regel (gebaut mit E3.1), Skill zur Einschleusungsprüfung und Rollenliste (gebaut mit E3.2), Prüfsatz (angelegt und gefahren mit E3.3), Schnitt E3.1 bis E3.3 | `.claude/rules/fremde-inhalte-im-harness.md` (ohne `paths:`); `.claude/skills/einschleusung-pruefen/SKILL.md`; Prüfsatz `scripts/einschleusung-pruefsatz/` (Inhalte unter `scripts/einschleusung-pruefsatz/inhalte/`, getrennt davon die Sollliste); Zuordnung in ADR 0001, Abschnitt 5.1; ADR 0002, 6.14; Backlog-Eintrag R3-Q-011 in `docs/05_Product_Backlog.md`; Begriffe Einschleusung, Fremder Inhalt und Harness in `docs/03_Glossar.md` |
