...
| Fremde Inhalte im Harness — E3 (R3-Q-011): Regel, Skill zur Einschleusungsprüfung, Prüfsatz, Rollenliste, Schnitt E3.1 bis E3.3 (festgelegt, nicht gebaut) | ADR 0002, 6.14; Backlog-Eintrag R3-Q-011 in `docs/05_Product_Backlog.md`; Begriffe Einschleusung, Fremder Inhalt und Harness in `docs/03_Glossar.md` |
