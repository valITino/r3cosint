...
| 2026-09-22 | R1 verlangte ein "mit einem Stakeholder abgestimmtes Bedürfnis" und einen benannten Stakeholder; ob ein Eintrag ready ist, dessen Stakeholder benannt und begründet ist, dessen Abstimmung aber erst mit der Freigabe durch den Auftraggeber eintritt, sagte die Zeile nicht. R3-Q-010 ist am 2026-09-21 mit genau diesem Vorbehalt als ready geführt und gezählt worden (Backlog, offener Punkt 19) | Lesart in R1 festgehalten: R1 verlangt die Abstimmung mit einem benannten Stakeholder; ist sie mit keinem belegt, tritt aber durch einen terminierten Schritt ein (Freigabe des Umfangs durch den Auftraggeber, sofern er benannt ist), ist der Eintrag ready mit ausdrücklichem Vorbehalt — in der Summe geführt, nicht in einen Sprint ziehbar, bis der Vorbehalt entfällt; die Abstimmung mit weiteren benannten Stakeholdern ist kein Erfordernis von R1 und wird als offener Punkt geführt. Kein Eintrag verlässt die Summe. Die Lesart senkt R1 nicht ab und heilt keinen fehlenden Stakeholder — die offenen Punkte 12 und 15 des Backlogs bleiben und sind durch Benennung nachzuführen | Entscheid des Auftraggebers vom 2026-09-22 durch Delegation an den Koordinator (Wortlaut: "Zu C: Das, was richtig ist und Sinn macht."). Die Alternative — die Einträge aus der Summe nehmen — hätte einen bereits abgenommenen Eintrag (R3-Q-001, Abnahme 2026-09-08, ADR 0002, Abschnitt 10) und die Etappe 0 rückwirkend ungeplant gemacht, ohne dass ein Bedürfnis weniger belegt wäre. Die Lesart macht die im Backlog geübte Praxis ausdrücklich, statt sie zu ändern. Für R3-Q-010 ist die Abstimmung mit S-01 am 2026-09-22 mit der Freigabe des Umfangs eingetreten; S-02 bleibt offen (Backlog, offener Punkt 15). Die erste Fassung desselben Tages liess den Vorbehalt pauschal "mit der Freigabe" entfallen, sagte zum Sprint-Eingang nichts und begründete die Gleichsetzung von Freigabe und Abstimmung nicht; drei Befunde des Requirements Engineers (Vorbehalt je Stakeholder, Sprint-Eingang, Gleichsetzung) sind vor dem Commit eingearbeitet, die Kriterienzeile nennt keine Einzelkennung mehr. Die Zählung von R3-Q-010 als ready am 2026-09-21 ist damit gedeckt: Stakeholder benannt und begründet, Abstimmung durch den terminierten Schritt (Backlog, offener Punkt 18) am 2026-09-22 eingetreten. Sechs weitere Befunde des Requirements Engineers an der berichtigten Fassung (Bestimmtheit des terminierten Schritts, Prüfmittel der Sprintsperre, Fachgebiet des Auftraggebers, Kopftext von Teil 1, gesonderter Ausweis, Rückwirkung) sind in derselben Einheit eingearbeitet; danach keine weitere Runde — was bleibt, ist offener Punkt, nicht Abbruchgrund |
...
Kriterien erfüllt sind. Abgeleitet aus den IREB-Qualitätskriterien (6.5). Ein
Eintrag, der nach R1 ready mit ausdrücklichem Vorbehalt ist, zählt in der
Summe, wird aber erst gezogen, wenn der Vorbehalt entfallen ist (Lesart in
R1, seit dem 2026-09-22).

## Je Eintrag

| Nr. | Kriterium | Woran es geprüft wird |
|---|---|---|
| R1 | **adäquat** | Bildet ein tatsächliches, mit einem Stakeholder aus `02_Stakeholderliste.md` abgestimmtes Bedürfnis ab. Der Stakeholder ist im Eintrag benannt. **Lesart seit dem 2026-09-22:** R1 verlangt die Abstimmung mit **einem** benannten Stakeholder; die Abstimmung mit weiteren benannten Stakeholdern ist kein Erfordernis von R1 und wird, wo sie aussteht, als offener Punkt des Backlogs geführt. Ist mindestens ein Stakeholder benannt und sein Bezug zum Eintrag begründet, die Abstimmung des Bedürfnisses aber mit keinem benannten Stakeholder belegt, so ist der Eintrag **ready mit ausdrücklichem Vorbehalt**, wenn die Abstimmung mit einem benannten Stakeholder durch einen bereits terminierten Schritt eintritt — im Regelfall die Freigabe des Umfangs durch den Auftraggeber, sofern er als Stakeholder benannt ist und das Bedürfnis des Eintrags in seinem Fachgebiet liegt: Er ist Auftraggeber und Fachstakeholder in einer Person, und die Freigabe erfolgt auf der Grundlage des Eintrags samt begründetem Bedürfnis, ist also die Abstimmung des Bedürfnisses, wie es dort steht. Terminiert ist ein Schritt, wenn er im Backlog als offener Punkt mit entscheidender Instanz geführt ist; Vorbehalt und Wegfall stehen mit Datum im Eintrag (Änderungshistorie). Der Vorbehalt steht im Eintrag; der Eintrag wird in der Summe geführt und bei jeder Nachführung der Summe vom Product Owner gesondert ausgewiesen, darf aber **nicht in einen Sprint gezogen** werden, solange der Vorbehalt besteht — Prüfmittel ist die Ready-Prüfung des Product Owners vor dem Ziehen; ein Vorbehalt verfällt nicht von selbst. Mit dem Eintritt der Abstimmung entfällt er, der Product Owner vermerkt das mit Datum im Eintrag, und R1 ist erfüllt. Diese Lesart senkt R1 nicht ab und heilt keinen fehlenden Stakeholder: Ein Eintrag ohne benannten Stakeholder erfüllt R1 nicht. Einträge aus dem Bestand vor dieser Lesart, die ohne benannten Stakeholder gezählt sind, stehen in den offenen Punkten 12 und 15 des Backlogs und sind durch Benennung nachzuführen; diese Lesart deckt sie nicht. |
