...
- **Nachweis:** Der ausgeführte Selbsttest `scripts/dod-gate-selbsttest.sh` in beiden Modi (Stand 2026-09-04: 154 Zusicherungen `Z-nnn` der Tabelle ADR 0002, 6.12.19; Normalmodus mit den Schlusszeilen "Selbsttest: 154 von 154 Zusicherungen bestanden", "Deckung: 154 Kennungen in der Tabelle, 154 geprueft, 0 ohne Pruefung, 0 ohne Kennung" und "Kanalabgleich: 154 Kennungen, 0 Abweichungen"; Mutationsmodus `--mutationen` gegen `scripts/dod-gate-mutationen.txt` mit der Schlusszeile "Mutationen: 145 geprueft, 145 erkannt, 0 nicht erkannt, 9 ohne Mutation (keine), 0 wirkungslos") und die unabhängige Prüfung durch Static und Dynamic Software Tester, auf einem anderen Modell als die Umsetzung (3.4).
