...
| **Stand** | 2026-08-26, nachgeführt (Befund F des Deep Reviews vom 2026-08-25: R3-F-022 bis R3-F-024 und R3-F-026 bis R3-F-028 neu in Etappe 1, R3-Q-006 neu in Etappe 3, R3-F-025 neu in Etappe 4, R3-F-015 und R3-F-002 um Rückverweis ergänzt; zweite Nachführung 2026-08-26 nach Koordinatorenprüfung (zwei unabhängige Prüfungen der ersten Einordnung nicht bestanden): R3-F-017 um zweites Abnahmekriterium und 2 h ergänzt, R3-F-024 selbstskalierend reformuliert und in Etappe 1 belassen, Querverweis in R3-F-023 korrigiert (R3-F-017 statt R3-F-018), Summen neu gerechnet, Offene Punkte ergänzt; frühere Stände: V-01 und V-04 aus `docs/08_Freigabe_Schritt_4.md`, O-1-Vermerk aus ADR 0002; dritte Nachführung 2026-08-31 nach Einordnung des Vergleichs mit `valITino/claude-skills-fullstack` (Stand `882ef55e377dbf9a4dbe496bb41ac6ccd0e555cf`): R3-Q-007 und R3-Q-008 neu in Etappe 0, R3-Q-009 neu in Etappe 0 und nicht ready, R3-F-029 neu in Etappe 1 und nicht ready, R3-F-062 neu in Etappe 3, Achtung-Hinweise ergänzt bei R3-Q-001, R3-F-008, R3-F-021, R3-F-054, Summen neu gerechnet, Offene Punkte um Nr. 13 und 14 ergänzt; vierte Nachführung 2026-08-31 nach unabhängiger Prüfung des Backlog-Commits vom selben Tag (drei nicht blockierende Beobachtungen): R3-F-062 um Gegenprobe ergänzt, R3-F-094 auf Kano und Prüfaufwand offen gesetzt und aus der Summe der zweiten Fassung genommen — Angleichung an R3-Q-009 und R3-F-029 —, R3-Q-007 zweites Abnahmekriterium anhand des Bestands der 21 Rollendateien geschärft, Summen neu gerechnet, Offene Punkte Nr. 2 ergänzt und um Nr. 17 erweitert; fünfte Nachführung 2026-09-08 nach ADR 0002, 6.12.28 (Nachtrag j Punkt 5) und Abschnitt 9: R3-Q-001 nachgeführt — Zeile "Offene Posten aus Runde 11" auf den in dieser Einheit behobenen blockierenden Teil und den verbleibenden nachrangigen Rest umgeschrieben; neue Zeile "Offene Posten aus Runde 12" mit den drei dort benannten Restlücken und den nachrangigen Befunden `SST-P3-01` bis `SST-P3-04`, `S12-04` und `S12-05` als Sammelposten unter demselben Eintrag ergänzt; Nachweis um den Stand 2026-09-08 ergänzt; neuer Stand-Vermerk 2026-09-08 zum Abschluss der Runde 12 (letzte Fremdmutationsrunde, Befund `DT12-M14` behoben, Abnahmevorlage dem Auftraggeber vorgelegt). Frühere Stand-Vermerke bleiben stehen (6.1.2); Summen, Etappenzuordnung und Offene Punkte unverändert); sechste Nachführung 2026-09-21, Teil 1: R3-Q-001 um den Stand-Vermerk zur am 2026-09-08 erteilten Abnahme des DoD-Gates ergänzt (ADR 0002, Abschnitt 10); Teil 2: R3-Q-010 (E4, die beiden PreToolUse-Gates) neu in Etappe 0, Kano und Prüfaufwand gesetzt, Summen neu gerechnet, Offene Punkte ergänzt; docs/03_Glossar.md um Gate und Hook ergänzt |
...
- **Abnahme:** Test `R3-Q-001_gate_blockiert` — bei einem Befund (eine Marke `A_FAIL`, `D19 VERLETZT` oder ein nicht nachweisbar gelaufener Lauf, `KETTE`-Schlüssel) endet der Hook mit Rückgabewert 2 und die Aufgabe lässt sich nicht abschliessen; als eigener, ebenfalls zu prüfender Fall: Ein Lauf, dessen einzige Abweichungen gedeckte terminierte Lagen C sind, endet mit Rückgabewert 0 und meldet sich über `systemMessage`; ein Lauf ohne Befund und ohne ungedeckte Lage C endet mit 0. Dazu, als Aufzählung nach ADR 0002, 6.12.19: bei gesetztem `stop_hook_active` endet der Hook mit 0, auch wenn die Kette einen Befund zeigt, und der Zähler bleibt unverändert; bei `TaskCompleted` und einem Befund endet der Hook mit 2; bei `SubagentStop` einer Rolle ohne `Edit`, `Write` oder `NotebookEdit` im Werkzeugzugriff endet der Hook mit 0, ohne dass die Kette läuft; scheitert dieselbe Prüfung am gleichen Kriterium zum dritten Mal, verlangt der Hook die Übergabedatei; ab dem vierten Mal lässt er ausschliesslich bei `Stop` und `SubagentStop` durch, und nur mit einer Übergabedatei, die die Zeile "Eskalation 3.4: <Schlüssel>" trägt; fehlt ein Prüfmittel des Gates, endet der Hook mit 2 unter Nennung des fehlenden Mittels.
- **Nachweis:** Der ausgeführte Selbsttest `scripts/dod-gate-selbsttest.sh` in beiden Modi (Stand 2026-09-06: 207 Zusicherungen `Z-nnn` der Tabelle ADR 0002, 6.12.19 mit Kanal und Prädikat; Normalmodus mit den Schlusszeilen "Selbsttest: 207 von 207 Zusicherungen bestanden", "Deckung: 207 Kennungen in der Tabelle, 207 geprueft, 0 ohne Pruefung, 0 ohne Kennung", "Kanalabgleich: 207 Kennungen, 0 Abweichungen", "Praedikatabgleich: 207 Kennungen, 0 Abweichungen", "Schluesseldeckung: 14 Schluessel, 0 ohne Zeile, 0 fremde Schluessel", "Grammatikdeckung: 11 Kuerzel, 0 ohne Zeile", "Aussagendeckung: 30 Kuerzel, 0 ohne Zeile, 0 fremde Etiketten, 0 Doppeletiketten" und "Gegenstandsdeckung Schluessel: 24 Literale, 0 ohne Zeile"; Mutationsmodus `--mutationen` gegen `scripts/dod-gate-mutationen.txt` mit der Schlusszeile "Mutationen: 197 geprueft, 197 erkannt, 0 nicht erkannt, 10 ohne Mutation (keine), 0 wirkungslos") und die unabhängige Prüfung durch Static und Dynamic Software Tester, auf einem anderen Modell als die Umsetzung (3.4). **Stand 2026-09-08 (nach Runde 12, ADR 0002, 6.12.28):** Tabelle 6.12.19 führt 263 Zeilen, 262 Zusicherungen (`Z-110` zurückgezogen), 264 Messhüllen, Prädikat `gleich` 174. Der ausgeführte Selbsttest lief in beiden Modi mit Rückgabewert 0 (Stand 2026-09-08, Commit `272e0a5cc138aeb0e24cfe423fcbc95227afd47a` auf dem Arbeitszweig): Normalmodus mit den Schlusszeilen "Selbsttest: 262 von 262 Zusicherungen bestanden", "Grammatikschwaechungen: 35 Schwaechungen, 35 wirksam, 0 ohne fallende Zusicherung", "Aufrufstellendeckung E21: 3 Aufrufstellen, 3 Fallfunktionen", "Pfaddeckung: 40 Ausgangsstellen, 0 nicht beschritten, 0 mit Ausnahme", "Schluesseldeckung: 18 Schluessel, 0 ohne Zeile, 0 fremde Schluessel", "Grammatikdeckung: 12 Kuerzel, 0 ohne Zeile, 0 fremde Etiketten", "Aussagendeckung: 31 Kuerzel, 0 ohne Zeile, 0 fremde Etiketten, 0 Doppeletiketten", "Gegenstandsdeckung Schluessel: 24 Literale, 0 ohne Zeile", "Deckung: 262 Kennungen in der Tabelle, 262 geprueft, 0 ohne Pruefung, 0 ohne Kennung", "Kanalabgleich: 262 Kennungen, 0 Abweichungen", "Praedikatabgleich: 262 Kennungen, 0 Abweichungen" und "Blockdeckung: 11 Etiketten erwartet, 0 ohne Zeile, 0 fremde Etiketten, 35 Zeilen im Block"; Mutationsmodus `--mutationen` mit den Schlusszeilen "Mutationsdeckung: 262 Kennungen in der Tabelle, 262 Eintraege in der Mutationsdatei" und "Mutationen: 250 geprueft, 250 erkannt, 0 nicht erkannt, 12 ohne Mutation (keine), 0 wirkungslos". Dazu Runde 12 (letzte Fremdmutationsrunde, gelaufen am 2026-09-07): 29 blind gewählte Fremdmutationen, 28 liessen mindestens eine Zusicherung fallen, ein blockierender Befund `DT12-M14` (falsches Grün an der Grammatik der D19-Zeile, 6.12.8), behoben mit den zwei neuen Zeilen `Z-262` und `Z-263`, statisch nachgeprüft und mit einer gezielten Wiederholung der Fremdmutation belegt (ADR 0002, 6.12.28 j).
- **Stand 2026-09-04:** Entwurf als ADR 0002, 6.12 vorgelegt; Bau auf Weisung des Auftraggebers vom 2026-09-02; acht Prüfrunden durch Static und Dynamic Software Tester auf einem anderen Modell, alle Befunde der Runden 1 bis 7 belegt behoben; O-24 (6.12.25) und O-25 (6.12.26) vom Auftraggeber entschieden und umgesetzt — 154 Zusicherungen, Deckung und Kanal mechanisch abgeglichen, Mutationsprobe je Zusicherung mit 145 von 145 erkannten Mutationen. Runde 8 statisch bestanden, dynamisch nicht bestanden: Sechzehn Fremdmutationen des Prüfers, fünf davon ohne fallende Zusicherung (Eskalationsschwelle, Zählschlüssel `KETTE schlusszeile-widerspruch`, Markengrammatik, Rückfallpfad der Baumbestimmung, innere Zeitgrenze) — achter Auftritt der Fehlerklasse "Selbsttestfall besteht, ohne seine Behauptung zu belegen"; Einheit nach 3.4 abgebrochen (ADR 0002, 6.12.26 g; `docs/uebergaben/2026-09-04_r3-q-001-o-25-kanal-und-mutation.md`). Vorgelegt ist O-26 (Prädikatbindung, Schlüssel- und Grammatikdeckung, Abnahmekriterium für den Selbsttest). Das Gate selbst verhält sich in allen dynamischen Prüfpunkten aller acht Runden richtig. Förmliche Freigabe der Entscheidpunkte E-A bis E-K und Abnahme stehen aus (ADR 0002, Abschnitt 10).
- **Stand 2026-09-06:** O-26 vom Auftraggeber entschieden ("Na dann weiter gehts, so wie du es sagst", Annahme des Vorschlags aus 6.12.26 g) und als ADR 0002, 6.12.27 umgesetzt: Prädikat je Zusicherung aus geschlossenem Vorrat mit maschinellem Prädikatabgleich; Schlüsseldeckung gegen 6.12.4 in beide Richtungen und Gegenstandsdeckung aus den Literalen des Gates; Grammatikdeckung gegen die Elementtabelle in 6.12.7 (elf Kürzel); Aussagendeckung gegen die Aussagentabellen in 6.12.9 und 6.12.15 (30 Kürzel); Ausgabeform als Invariante über alle Gate-Aufrufe; 53 neue Zusicherungen (`Z-156` bis `Z-208`), `Z-040` und `Z-080` berichtigt; Abnahmekriterium für den Selbsttest (6.12.27 g). Bau in sechs Phasen mit zwei Zwischenkontrollen. Runden 9, 10 und 11 als Fremdmutationsrunden mit blinder Wahl auf einem anderen Modell: Teil 1 des Abnahmekriteriums je erfüllt und statisch bestätigt, Teil 2 dreimal nicht erfüllt (drei, sieben und zehn unerkannte Fremdmutationen; Klasse: Deckung an der Aufzählung, nicht am Gegenstand — Schwächungen des Markenmusters, unbetretene Ausgangspfade des Gates, mehrere Aufrufstellen einer Aussage). Einheit nach 3.4 abgebrochen, wie in 6.12.27 j Punkt 8 vorab festgelegt (`docs/uebergaben/2026-09-06_r3-q-001-o-26-praedikat-und-deckung.md`). Vorgelegt ist O-27 (6.12.27 k): Weg (a) Deckung am Gegenstand für Pfade und Grammatik mit einer Runde 12, Weg (b) Abnahmekriterium auf falsches Grün am Gate beziehen. Das Gate selbst war in elf Runden gegen echte Bäume nie falsch grün. Förmliche Freigabe der Entscheidpunkte E-A bis E-K und Abnahme stehen aus (ADR 0002, Abschnitt 10).
- **Offene Posten aus Runde 11 (Sammelposten unter diesem Eintrag, kein eigener Backlog-Eintrag):** Die nach 6.12.27 g blockierenden Posten sind in dieser Einheit (ADR 0002, 6.12.28) behoben: DT11-01 bis DT11-05 (weitere Verstossformen der Markengrammatik, 35 Schwächungen), DT11-06 (`E21` jetzt an allen drei Aufrufstellen gemessen, Aufrufstellendeckung `Z-258`), DT11-07 bis DT11-10 (Pfaddeckung über 40 Ausgangsstellen), DT11-11 (Gate-Berichtigung, vier einheitliche Meldungszeilen, vier neue Schlüssel in 6.12.4, Aussage `E23`), S11-04 bis S11-06 (Deckungen fail-closed). Weiterhin offen bleiben die nachrangigen Posten S11-02, S11-03, S11-09, S11-10, S10-06, SST-B5-09, S9-05 (ADR 0002, 6.12.27 k, 6.12.28 und Abschnitt 9).
- **Offene Posten aus Runde 12 (Sammelposten unter diesem Eintrag, kein eigener Backlog-Eintrag; ADR 0002, 6.12.28 j Punkt 5 und Abschnitt 9):** Drei dokumentierte Restlücken. (1) Die Grammatik der D19-Zeile (6.12.8) ist nicht am Gegenstand gedeckt — geschlossen ist die eine belegte Verstossform (`Z-262`, `Z-263`); ein Schwächungslauf über das D19-Muster ist nicht Gegenstand dieser Einheit (6.12.28 g: keine Runde 13). (2) Zeichen im Inneren eines Wortliterals des `marken_muster` werden nicht einzeln geschwächt. (3) Eine Alternative mit einem bestimmten fremden Literal ist nur als Klasse erfasst; für die D19-Grammatik besteht dazu kein Gegenstück. Dazu die nachrangigen Befunde der Runde 12: SST-P3-01 bis SST-P3-04, S12-04, S12-05.
- **Stand 2026-09-07:** O-27 entschieden — der Auftraggeber hat die Wahl an den Koordinator delegiert ("Dann wähle den besten und korrektesten Weg aus, ich vertraue dir und deiner Expertise."); gewählt sind Weg (a) und Weg (b) zusammen in einer Einheit: Pfaddeckung über die Ausführungsspur des Gates (jede Ausgangsstelle mindestens einmal beschritten), Grammatikdeckung über mechanisch erzeugte Schwächungen des Markenmusters, beide fail-closed; DT11-06, DT11-11 und S11-04 bis S11-06 behoben; Teil 2 des Abnahmekriteriums auf falsches Grün am Gate bezogen; Runde 12 als letzte Fremdmutationsrunde, danach Abnahmevorlage oder dokumentierte Restlücke (ADR 0002, 6.12.27 k; Ausformung als 6.12.28 zu Beginn der nächsten Einheit). Sitzungsauftrag: `docs/vorlagen/2026-09-07_sitzungsauftrag-o-27.md`. Der Merge des Arbeitszweigs ist die förmliche Freigabe der Entscheidpunkte E-A bis E-K (Abschnitt 10); die Abnahme des Gates folgt nach Runde 12.
- **Stand 2026-09-08:** Runde 12 (letzte Fremdmutationsrunde nach 6.12.28 g) ist am 2026-09-07 gelaufen: 29 blind gewählte Fremdmutationen, 28 liessen mindestens eine Zusicherung fallen, ein blockierender Befund — `DT12-M14`, falsches Grün an der Grammatik der D19-Zeile (6.12.8). Behoben mit den zwei neuen Zeilen `Z-262` und `Z-263`, statisch nachgeprüft und mit einer gezielten Wiederholung der Fremdmutation belegt; eine Runde 13 gibt es nicht (ADR 0002, 6.12.28 j). **Teil 1** des Abnahmekriteriums (6.12.28 g) ist erfüllt. **Teil 2 ist nicht erfüllt**: Er verlangt eine Fremdmutationsrunde **ohne** blockierenden Befund, und Runde 12 hatte einen. Gegriffen hat stattdessen der in 6.12.28 g für genau diesen Fall vorab festgelegte Weg — beheben, statisch nachprüfen, gezielte Wiederholung, keine Runde 13, Restlücke dokumentieren. Die Abnahme wird auf dieser Grundlage vorgelegt, nicht auf der Grundlage eines bestandenen Teils 2. Drei dokumentierte Restlücken bleiben offen (siehe "Offene Posten aus Runde 12" oben). Die Abnahme des Gates wird dem Auftraggeber mit dieser Einheit vorgelegt (ADR 0002, Abschnitt 10); die förmliche Freigabe der Entscheidpunkte E-A bis E-K ist bereits mit dem Merge des Arbeitszweigs erteilt (Stand 2026-09-07 oben).
- **Stand 2026-09-21:** Die Abnahme des Prüfmittels aus R3-Q-001 ist am 2026-09-08 durch den Merge des Pull Requests #15 erteilt — Merge-Commit `9870b0d115b8ef330a7c19777af5741093e4f0e9`, 09:51:49 UTC, ohne Auflagen (kein Kommentar, kein Review), Formweg 1 aus ADR 0002, Abschnitt 10. Wortlaut im Text des Pull Requests: "Der Merge dieses Pull Requests gilt als Erteilung der Abnahme des Prüfmittels aus R3-Q-001 ..."; zugehöriger Merge im Methodik-Repository `9c28499252ab3f42a96dc43bf096c3a6353ce0cb`. Die Abnahme umfasst das Prüfmittel im Umfang der Abnahmevorlage (ADR 0002, Abschnitt 10); **nicht** umfasst sind O-25 (bleibt offen), die Abnahme des Belegprüfers D20 (O-15, bleibt offen), R3-Q-005 und die Freigabe des Grundgerüsts. Ohne Beschönigung: Teil 1 des Abnahmekriteriums ist erfüllt, Teil 2 NICHT — getragen hat der in ADR 0002, 6.12.28 g vorab festgelegte Weg. Die drei Restlücken aus "Offene Posten aus Runde 12" bleiben als Posten offen; die Abnahme benennt sie, sie sind dadurch nicht geschlossen. Angaben aus der Erhebung des Koordinators vom 2026-09-21 (git und GitHub-API).
...
### R3-Q-010 — main-Gate und Prototyp-Gate: belegte Lücken geschlossen, Wirkung mit versioniertem Prüfmittel belegt
- **Art:** Qualitätsanforderung · **Kano:** Basisfaktor · **Prüfaufwand:** 5 h · **Quelle:** 3.2 c, 5.6, 3.4 · **Etappe:** 0
- **Stakeholder:** S-01 (Auftraggeber und Ermittler Cybercrime) — beide Gates setzen Entscheide durch, die er getroffen hat: den Schutz von main als Hook statt als Satz (3.2 c) und die Trennung von Prototyp und Produktionscode bis zur Prototyp-Freigabe (5.6); ein Gate, das eine Umgehung durchlässt, gibt ihm eine Zusicherung, die es nicht trägt. S-02 (Studienkollege, Review und Feinschliff) — er arbeitet am selben Repository; ein Schreibzugriff, der an main vorbeigeht, trifft seinen Prüfweg über Pull Requests unmittelbar, und ein Gate ohne Prüfmittel ist für ihn nicht nachvollziehbar.
- **Formulierung:** Die beiden PreToolUse-Gates `.claude/hooks/block-main-write.sh` und `.claude/hooks/block-prototype-import.sh` erkennen die im Zustandsbericht vom 2026-09-02 belegten und heute offenen Umgehungswege, behandeln eine nicht auswertbare Eingabe wie ein fehlendes Prüfmittel, und ihre Wirkung ist durch ein versioniertes Prüfmittel je Gate belegt statt behauptet; was ein Gate bewusst nicht prüft, steht als Grenze in seinem Kopfkommentar. Messgrösse: über den versionierten Prüfsatz beider Gates null Fälle, in denen ein als blockierend geführter Fall mit Rückgabewert 0 oder ein als zulässig geführter Fall mit Rückgabewert 2 endet, gemessen über je einen vollständigen Lauf des Prüfmittels je Gate.
- **Abnahme:** Test `R3-Q-010_prototyp_gate_pfadformen` — über beide Richtungen des Prototyp-Gates und je im Gate geführter Importgrammatik (`from`, `import`, `require(`, dynamisches `import(`, `@import`) führt der Prüfsatz jede belegte Schreibweise desselben Ziels, mindestens den Verzeichnisimport ohne Schrägstrich (`"../prototype"`, `'../../prototype'`) und den mit `"./"` beginnenden gleichwertigen Pfad (`"./../backend/api"`); jeder dieser Fälle endet mit Rückgabewert 2 und einer Meldung, die 5.6 nennt, und nach dem Lauf existiert im Arbeitsbaum keine neue und keine geänderte Datei; ein Import ohne Bezug auf die jeweils andere Seite (`"./local"`) und ein Edit, das einen verbotenen Import entfernt, laufen mit Rückgabewert 0 durch.
- **Abnahme:** Test `R3-Q-010_prototyp_gate_richtungsgleichheit` — über jede Bezugsform, die das Prototyp-Gate in Richtung Produktionscode auf Prototyp erkennt, erkennt es dieselbe Form auch in der Gegenrichtung; der Prüfsatz führt dazu mindestens die HTML-Formen `src=` und `href=` in einer Datei unterhalb von `prototype/`, die auf Produktionscode zeigen; jeder dieser Fälle endet mit Rückgabewert 2 und die Meldung nennt die Richtung, und nach dem Lauf existiert im Arbeitsbaum keine neue und keine geänderte Datei; ein HTML-Verweis auf eine Datei desselben Verzeichnisses läuft mit Rückgabewert 0 durch.
- **Abnahme:** Test `R3-Q-010_prototyp_gate_schreibwirkung` — über jede Befehlsklasse, die das main-Gate als schreibend führt, erkennt auch das Prototyp-Gate die Schreibwirkung eines Bash-Befehls; der Prüfsatz führt je einen Aufruf eines Interpreters mit Inline-Code, dessen geschriebener Text einen verbotenen Import trägt; jeder dieser Fälle endet mit Rückgabewert 2, und nach dem Lauf existiert im Arbeitsbaum keine neue und keine geänderte Datei; derselbe Interpreteraufruf ohne Importmuster und ein reines Lesen oder Suchen mit demselben Wortlaut laufen mit Rückgabewert 0 durch.
- **Abnahme:** Test `R3-Q-010_gates_unlesbare_eingabe` — über beide PreToolUse-Gates endet ein Aufruf, dessen Eingabe sich nicht auswerten lässt, mit Rückgabewert 2 und einer Meldung auf der Standardfehlerausgabe, die die nicht lesbare Eingabe benennt, während die Standardausgabe leer bleibt; der Prüfsatz führt je Gate die leere Eingabe, eine nicht als JSON lesbare Eingabe und eine syntaktisch gültige Eingabe, deren Feld `tool_input` eine Zeichenkette statt eines Objekts trägt; eine wohlgeformte Eingabe ohne Verstoss läuft mit Rückgabewert 0 durch.
- **Abnahme:** Test `R3-Q-010_pruefmittel_je_gate` — für jedes der beiden PreToolUse-Gates besteht ein versioniertes Prüfmittel, das mindestens einen blockierenden und einen durchzulassenden Fall führt (Hook-Regel in `.claude/rules/claude-konfiguration.md`: ein ungetestetes Gate ist kein Gate) und zu jedem Sachverhalt dieses Eintrags mindestens einen Fall; ein vollständig bestandener Lauf endet mit Rückgabewert 0, nennt je Fall dessen Kennung, den erwarteten und den gemessenen Rückgabewert und ändert keine versionierte Datei des Arbeitsbaums; wird eine Sperre des geprüften Gates versuchsweise entfernt, endet derselbe Lauf mit einem Rückgabewert ungleich 0 und nennt den gefallenen Fall; als Gegenprobe gilt: die am 2026-09-21 mit Rückgabewert 0 durchlaufenden Gegenproben (Statusabfrage, Abzweigen eines neuen Zweigs, Arbeitsbaum mit ausdrücklich neuem Zweig, Suchen und Lesen, Umleitung nach /dev/null am main-Gate; Import ohne Bezug auf die andere Seite, Prosa in einer Markdown-Datei, Prototyp-Datei ohne Import, Edit, das einen verbotenen Import entfernt, am Prototyp-Gate) laufen im Prüfmittel unverändert mit Rückgabewert 0 durch; eine Änderung, die eine davon auf 2 hebt, gilt als gefallener Fall.
- **Abnahme:** Test `R3-Q-010_main_gate_fremdbelegt` — über die drei am 2026-09-03 behobenen Befunde ST-01 bis ST-03 des Zustandsberichts führt der Prüfsatz des main-Gates je Befund mindestens einen blockierenden Fall (Push nach main mit einfachem und mit doppeltem Anführungszeichen, in einer Befehlskette und in Klammern; Anlegen eines Arbeitsbaums auf main mit gequotetem Zweignamen; Aufruf ohne `git` im Suchpfad), jeder dieser Fälle endet mit Rückgabewert 2, und nach dem Lauf existiert im Arbeitsbaum keine neue und keine geänderte Datei, und der Lauf ist von einer Prüfrolle auf einem anderen Modell als die Umsetzung bestätigt (3.4); die Gegenproben Statusabfrage, Abzweigen eines neuen Zweigs und Anlegen eines Arbeitsbaums mit ausdrücklich neuem Zweig laufen mit Rückgabewert 0 durch.
- **Abnahme:** Test `R3-Q-010_benannte_grenzen` — über jede Fallklasse, die der Kopfkommentar eines der beiden Gates als gedeckt behauptet, führt der Prüfsatz mindestens einen Fall, der mit Rückgabewert 2 endet, und über die eine der drei Trennungsanforderungen aus 5.6, die das Prototyp-Gate nach dem Befund P-10 der Dimension Prototyp (5.6) nicht prüft — die gemeinsamen Abhängigkeiten —, steht die Nichtprüfung als Grenze im Kopfkommentar desselben Gates; eine Klasse, die der Kopfkommentar ausdrücklich als Grenze benennt (Kontextwechsel in einer Subshell oder in einem untergeordneten Shell-Aufruf, ein ausserhalb der Sitzung angelegter zweiter Arbeitsbaum, ein Aufruf ausserhalb eines Repositories), wird als durchlaufender Fall geführt und endet mit Rückgabewert 0.
- **Nachweis:** Der ausgeführte Lauf des versionierten Prüfmittels je Gate mit Rückgabewert 0 und der Fallliste in der Ausgabe; Ort, Name und Ausgabeform legt der Software Architect mit der Einordnung in ADR 0002 fest, Vorbild ist der Selbsttest des Definition-of-Done-Gates (`scripts/dod-gate-selbsttest.sh`). Dazu der Prüfbericht einer Prüfrolle auf einem anderen Modell als die Umsetzung (3.4), die den Lauf mit eigenen Fällen wiederholt; ohne ihn gilt kein Sachverhalt dieses Eintrags als belegt.
- **Achtung:** Kano (Basisfaktor) und Prüfaufwand (5 h) am 2026-09-21 durch den Product Owner geprüft und bestätigt, unverändert gegenüber dem Vorschlag des Requirements Engineers. Basisfaktor, weil ein Gate, das sich lautlos umgehen lässt, eine stillschweigend vorausgesetzte Eigenschaft verletzt — dieselbe Einordnung wie bei R3-Q-001 und R3-Q-005 —, ohne dass eine schärfere Erkennung zusätzliche Begeisterung auslöst. 5 h Prüfaufwand, weil sieben Abnahmekriterien über zwei Gates zu verifizieren sind, einschliesslich des Prüfberichts einer Rolle auf einem anderen Modell als die Umsetzung (3.4) — mehr als R3-Q-001 (4 h, ein Gate) und R3-Q-005 (3 h, noch nicht gebaut), im selben Grössenbereich wie R3-C-003 (5 h).
- **Abhängigkeit:** Vorbedingung erfüllt — R3-Q-001 ist am 2026-09-08 abgenommen (Merge-Commit `9870b0d115b8ef330a7c19777af5741093e4f0e9`); die Definition-of-Done-Kette greift damit über jede Änderung an den beiden Gates. Seitwärts zu R3-Q-005: dort geht es um ein noch nicht bestehendes Gate für die Rollen-Schreibgrenzen, hier um die beiden bestehenden Gates — andere Frage, keine gemeinsame Umsetzung. Der Kettenschritt D10 (Prototyp-Trennung) bleibt Lage C und wird von diesem Eintrag nicht erfüllt: der bestehende PreToolUse-Hook leistet die für D10 verlangte Stapelprüfung über den Bestand nicht (`docs/06_Definition_of_Ready_und_Done.md`, Zeile D10); ob sie als Betriebsart desselben Skripts entsteht, ist als ADR 0002, O-8 offen und mit dem Grundgerüst terminiert.
- **Achtung:** Bewusst **nicht** aufgenommen, je mit Grund: **ST-10** (der `SessionStart`-Matcher führt den Auslöser fork nicht) — das betrifft den Eingangskanal aus dem Methodik-Repository, einen Hook, der nie blockiert, und damit kein Gate; **ST-11** (die beiden `PreToolUse`-Matcher führen PowerShell nicht) — in dieser Umgebung besteht das Werkzeug nicht, und ob die auf Shell-Grammatik zugeschnittene Textprüfung über einen in einer anderen Sprache abgesetzten Befehl trägt, ist nicht belegt und mit statischen Mitteln nicht zu belegen; ein Matcher-Eintrag allein wäre eine Zusicherung ohne Messung; **ST-06**, **ST-12** und **ST-14** (Belegprüfer) sowie **ST-07** (Nachweiserzeuger) — Skripte der Kette, keine Gates; ihre Abnahme ist als ADR 0002, O-15 offen; **ST-08** und **ST-15** (Arbeitsabläufe des Nachweisflusses) — kein Gate; **K-01** (der Belegprüfer liest nur versionierte Dateien) — Kettenschritt D20, kein Gate; die **Prüfung gemeinsamer Abhängigkeiten** aus **P-10** der Dimension Prototyp (5.6) — das wäre eine neue Fähigkeit und keine Lücke an einer bestehenden Prüfung, aufgenommen ist allein das Benennen der Grenze; jede weitere Härtung ohne belegte Lücke — kein neuer Werkzeugname im Matcher, keine neue Befehlsklasse, kein weiteres Verzeichnis, solange keine ausgeführte Probe dafür eine Lücke zeigt.
- **Achtung:** **ST-13 ist aufgenommen, obwohl der Zustandsbericht ihn unter den widerlegten Befunden führt.** Der operative Teil des Befunds ist dort ausdrücklich bestätigt — der Lauf endet mit 0 — und am 2026-09-21 von zwei Stellen unabhängig nachgemessen worden; die Zelle mit dem Grund der Widerlegung bricht im Bericht mitten im Satz ab, der Grund ist nicht überliefert und deshalb nicht nachprüfbar. Die Richtung der Nachbedingung ist nicht gesetzt, sondern am Bestand abgelesen: Beide Gates blockieren bereits bei fehlendem `jq`, das main-Gate seit dem 2026-09-03 auch bei fehlendem `git`, und das abgenommene Definition-of-Done-Gate behandelt eine nicht als JSON lesbare Eingabe mit Rückgabewert 2 (ADR 0002, 6.12.28 e). Beurteilt der Software Architect das bei der Einordnung anders, ist das eine Fortschreibung von ADR 0002 und kein stillschweigendes Abweichen; bis dahin ist diese Nachbedingung eine ausdrücklich benannte Annahme (R4 der Definition of Ready). *Nachtrag vom 2026-09-21: Der Software Architect hat bei der Einordnung in ADR 0002, 6.13 b keine Abweichung festgestellt und die Nachbedingung Rückgabewert 2 ausdrücklich bestätigt — die Annahme nach R4 ist damit entschieden, und das Abnahmekriterium `R3-Q-010_gates_unlesbare_eingabe` gilt unverändert in der Fassung dieses Eintrags. Der Satz davor bleibt als Stand vor dem Entscheid stehen (ADR 0002, 6.1.2).*
- **Achtung:** **ST-01 bis ST-03 sind behoben**, mit Commit `0b3510a3fd8b219c82c093b34be3aff50c68f7e0` vom 2026-09-03. Dieser Eintrag baut sie nicht erneut; er liefert allein die fehlende Verifikation: Die Behebung ist bis heute ausschliesslich durch die umsetzende Einheit selbst belegt, und 3.4 verlangt, dass die Rolle, die umsetzt, nicht ihre eigene Arbeit prüft.
- **Achtung:** Herkunft: Befund **BER-05** des Zustandsberichts vom 2026-09-02 (`docs/10_Zustandsbericht_2026-09-02.md`), dort unter den widerlegten Befunden mit der abweichenden Beurteilung des Koordinators, und Punkt 4 der Tabelle "Arbeitseinheiten in der freigegebenen Reihenfolge" desselben Berichts. Der Umfang von E4 war in keinem Dokument des Repositories festgelegt; die einzige Quelle war ein Satz der Übergabe vom 2026-08-25 (`docs/uebergaben/2026-08-25_eingangskanal-repariert.md`): "E4 (main-Gate) rückt nach hinten. ... Der Umfang bleibt, die Dringlichkeit fällt weg."
- **Achtung:** Massgeblich für den Umfang sind ausschliesslich die belegten Lücken, nicht das, was ein Gate sonst noch könnte. Die Gates bleiben die zweite Verteidigungslinie: Auf main greift zusätzlich ein serverseitiges Regelwerk mit Blockade von Force-Pushes und Pull-Request-Pflicht (Übergabe vom 2026-08-25). Dieser Eintrag ändert daran nichts und beansprucht keine harte Zusicherung gegen Textprüfung, die Textprüfung nicht leisten kann.
- **Einordnung (Software Architect, ADR 0002, 6.13, vom 2026-09-21):** Der Eintrag ist architektonisch eingeordnet, **ohne dass ein Abnahmekriterium geändert wurde**; die dortigen Festlegungen machen ihn ausführbar, sie ändern ihn nicht. Festgehalten werden sie hier nur zur Verfolgbarkeit seitwärts (6.6): (1) **ST-13 entschieden** — die Nachbedingung Rückgabewert 2 ist bestätigt, die Annahme nach R4 ist damit keine Annahme mehr (Nachtrag in der Achtung-Zeile zu ST-13 oben). (2) **Schnitt unverändert bestätigt:** E4.1 (versioniertes Prüfmittel am heutigen Stand, ohne eine Zeile an den beiden Gates zu ändern; schliesst `R3-Q-010_pruefmittel_je_gate` und `R3-Q-010_main_gate_fremdbelegt` ab), E4.2 (Erkennungslücken ST-04, ST-05, P-01 der Dimension Prototyp (5.6)), E4.3 (Verhalten an den Rändern: ST-09, ST-13, benannte Grenzen). Damit E4.1 mit Rückgabewert 0 enden kann, führt der Prüfsatz die heute offenen Lücken als Fälle der Klasse "belegte Lücke" mit dem heute gemessenen Rückgabewert als Soll und der Befundkennung im Vermerk; in E4.2 und E4.3 wird je Befund zuerst das Soll auf 2 gesetzt, dann das Gate geändert, dann der Vermerk entfernt. Ein nach E4.3 verbliebener Vermerk ist ein offener Befund. (3) **Ort und Form des Prüfmittels** (Nachweiszeile dieses Eintrags, die Ort, Name und Ausgabeform dem Software Architect überlässt): ein einziges versioniertes Skript `scripts/pretooluse-gates-selbsttest.sh` statt zweier Dateien. Die Forderung von `R3-Q-010_pruefmittel_je_gate`, für jedes der beiden Gates ein Prüfmittel mit mindestens einem blockierenden und einem durchzulassenden Fall zu haben, bleibt wörtlich erfüllt: Jeder Fall trägt sein Gate als Feld, und der Lauf weist die Zahl der blockierenden und der durchlaufenden Fälle je Gate gesondert aus; sind es für ein Gate null, fällt der Lauf. (4) **Zähleinheit von `R3-Q-010_benannte_grenzen`** — die offene Frage des Requirements Engineers ist dort entschieden: Die Liste der vom Kopfkommentar als gedeckt behaupteten Fallklassen wird einmal abgezählt, im Prüfmittel geführt und in der Ausgabe genannt; sie darf nicht bei jedem Lauf neu entstehen, sonst wandert die Deckung mit dem Text. (5) **Mass des Prüfmittels** bewusst niedriger als bei ADR 0002, 6.12.19 bis ADR 0002, 6.12.28: keine Zusicherungstabelle, keine mechanischen Deckungen, keine eigene Mutationsdatei; die Mutationen stehen im Skript selbst, mindestens eine entfernte oder geschwächte Sperre je Gate. Der Vorbildverweis der Nachweiszeile auf `scripts/dod-gate-selbsttest.sh` betrifft Ort und Ausgabeform, nicht das Mass; Begründung und Grenze dieses Masses stehen in ADR 0002, 6.13 d. (6) **Ausgangsmenge:** Die Gegenprobe G04 trägt das Soll 2 — die im Kopfkommentar des main-Gates beschriebene gewollte Wirkung —, nicht 0. Die Differenz zwischen 44 ausgegebenen Zeilen des Fremdbelegs und 37 mit Kennung geführten Proben ist am Probeskript ausgezählt (Übergabe vom 2026-09-21, ADR 0002, 6.13 d): Die sieben weiteren Zeilen sind die Abweichungsmeldungen des Skripts zu G04, B02, B03, B06, B07, B08 und B09, keine Proben. (7) **Die Zusatzfälle 9 und 10** (Reichweite der Ausnahmeliste des Prototyp-Gates für eine Datei unterhalb von `.claude/`; Werkzeugname `bash` statt `Bash`) sind **Prüffälle, keine Befunde**: Ihr gemessenes Ergebnis wird als heutiger Stand geführt, und eine Änderung am Gate folgt daraus nur über eine Fortschreibung von ADR 0002, 6.13 — sonst fiele sie unter die in diesem Eintrag ausgeschlossenen Härtungen ohne belegte Lücke. (8) **Regressionsschutz:** die heute grünen Gegenproben bleiben grün (ADR 0002, 6.13 f Punkt 2) — mit diesem Nachtrag in das Abnahmekriterium `R3-Q-010_pruefmittel_je_gate` aufgenommen, damit der Backlog der vollständige Massstab bleibt.
- **Achtung:** **R1 der Definition of Ready ist nur zur Hälfte belegt.** Benannt und in ihrem Bezug zum Eintrag begründet sind die Stakeholder S-01 und S-02 (`docs/02_Stakeholderliste.md`); **nicht belegt und im Eintrag auch nicht behauptet ist die Abstimmung des Bedürfnisses mit ihnen selbst.** Für S-01 tritt sie mit der Freigabe des Umfangs durch den Auftraggeber ein, für S-02 bleibt sie offen. Der Eintrag ist ready mit diesem Vorbehalt und in der Summe geführt, wie R3-Q-001 bis R3-Q-009 (offene Punkte 12 und 15); die Definition of Ready ist für diese Lesart nicht fortgeschrieben (offener Punkt 19). Nachzuführen zusammen mit den offenen Punkten 12 und 15 des Backlogs (R3-Q-001 bis R3-Q-009 tragen keinen benannten Stakeholder), sobald der Auftraggeber den Umfang von R3-Q-010 freigegeben hat — Requirements Engineer.
- **Achtung:** Der offene Punkt **O-28** (ADR 0002, 6.13 c — die beiden `PreToolUse`-Matcher führen PowerShell nicht, Befund ST-11) ist **keine Zeile dieses Backlogs**: Er betrifft R3-Q-010 inhaltlich nicht, weil ST-11 hier ausdrücklich nicht aufgenommen ist und eine Aufnahme ohne Messung eine Zusicherung ohne Deckung wäre. Nachzuführen ist er in ADR 0002, Abschnitt 8 — Software Architect.
- **Achtung:** Nachtrag 2026-09-21 nach der Prüfung: `R3-Q-010_pruefmittel_je_gate` um den Regressionsschutz und zwei Kriterien um die Zustandsaussage ergänzt, die Zähleinheit von `R3-Q-010_benannte_grenzen` abgezählt; Prüfaufwand unverändert (der Product Owner bestätigt).
...
- **Abnahme:** Test `R3-Q-007_schreibgrenze_im_text_benannt` — für jede Rolle, deren `tools`-Feld `Write`, `Edit`, `Bash` oder ein gleichwertiges veränderndes Werkzeug führt, findet eine Textsuche im Rollenkörper mindestens eine Passage, die entweder (a) ein Verzeichnis oder einen Pfad benennt, dem die Schreib- oder Ausführungsrechte der Rolle zugeordnet oder von dem sie ausgeschlossen sind, oder (b) einen Arbeitsprodukt- oder Artefakttyp positiv oder als Negativliste benennt, den die Rolle schreiben darf oder nicht schreiben darf; eine Rolle ohne eine solche Passage lässt den Test fehlschlagen.
...
- **Achtung:** Der Massstab für das zweite Abnahmekriterium ist am Bestand von `.claude/agents/*.md`, Abschnitt "Grenzen und Rechte", abgeleitet, nicht gesetzt (Product Owner, 2026-08-31, gegen den tatsächlichen Dateiinhalt geprüft). Zwei Formen kommen dort tatsächlich vor: die Pfadform (protocol-master: "nur `docs/`"; ux-ui-designer, frontend-engineer, full-stack-engineer: Prototyp-Verzeichnis gegen Produktionscode; dynamic-software-tester: Testverzeichnisse) und die Artefaktform, positiv oder als Negativliste (product-owner: "das verantwortete Arbeitsprodukt Product Backlog"; software-architect: "Architecture Decision Records und das Kontextmodell"; ebenso bei scrum-master, legal-reviewer, digital-forensics-spezialist, security-specialist-grc, vulnerability-manager, datenschutzexperte, requirements-engineer, meist ergänzt um "kein Produktionscode, kein Testcode"). Beide Formen deckt der obige Wortlaut.
- **Achtung:** Der abgeleitete Massstab ist nicht vollständig tragfähig, und das wird hier offen benannt statt verdeckt: Vier Rollen mit vollem Schreibrecht — Backend Engineer, SecDevOps Engineer, DevOps Engineer, Docker- und Kubernetes/Portainer-Experte — benennen im Bestand vom 2026-08-31 weder ein Verzeichnis noch einen Arbeitsprodukt- oder Artefakttyp; ihre Grenzen sind ausschliesslich funktional formuliert (wer stattdessen zuständig ist, zum Beispiel docker-kubernetes-experte: "Ändert keine Anwendungslogik; ... liegt beim Backend Engineer"). Ob eine solche funktionale Zuständigkeitsabgrenzung als Arbeitsprodukt- oder Artefaktgrenze im Sinne dieses Kriteriums zählt, lässt sich am Bestand nicht entscheiden, ohne die drei Begriffe selbst enger zu fassen, als der Kandidat sie fasste — das wäre die Erfindung eines Massstabs, nicht seine Ableitung. Diese Konkretisierung fällt deshalb mit der Umsetzung von R3-Q-007 (siehe Offene Punkte, Nr. 17), nicht mit diesem Backlog-Eintrag.
...
- **Achtung:** Gegenprobe ergänzt am 2026-08-31 nach der Notation der Abnahmekriterien zu R6 (`docs/06_Definition_of_Ready_und_Done.md`, Abschnitt "Notation der Abnahmekriterien (R6)"), Pflicht bei jedem Kriterium, das eine Sperre oder Abweisung verlangt: Ein Kriterium, das nur die Gleichheit zweier Fehlerantworten prüft, ist auch dann grün, wenn beide Wege gar keine Daten liefern, etwa weil der lesende Zugriff selbst nie gebaut wurde. Erst der zulässige Fall — ein existierender und zugänglicher Gegenstand liefert seine Daten normal — unterscheidet eine wirksame Sperre von einer fehlenden Fähigkeit. Prüfaufwand unverändert (3 h): dieselbe Testreihe erhält eine zusätzliche Zusicherung, keinen zweiten Testnamen.
...
- **Art:** funktional · **Kano:** offen (siehe Achtung) · **Prüfaufwand:** offen (siehe Achtung) · **Quelle:** 5.8, 9.1 · **Etappe:** zweite Fassung
...
- **Abnahme:** Wird bei der Verfeinerung geschnitten. **Erfüllt die Definition of Ready derzeit nicht** — der Umfang ist nicht eindeutig (R3), und ohne festen Umfang lässt sich kein Abnahmekriterium formulieren (R6). Der Eintrag bleibt bewusst grob, bis der Auftraggeber ihn schneidet.
- **Achtung:** Kano und Prüfaufwand am 2026-08-31 auf offen gesetzt und aus der Summe genommen (vorher: Leistungsfaktor, 5 h, in der Summe der zweiten Fassung mitgezählt) — Angleichung an R3-Q-009 und R3-F-029, die beide seit dem 2026-08-31 mit derselben Begründung ohne Kano-Einordnung und ohne Prüfaufwand geführt werden. Grund, tragend und nicht nur formal: Ein Eintrag, der die Definition of Ready nicht erfüllt, weil sein Umfang nicht feststeht, lässt sich so wenig seriös schätzen wie einer, dessen Abnahmekriterium nicht formulierbar ist — "5 h" für "den vollen Funktionsumfang eines Ticketsystems" war eine Vermutung, kein Ergebnis einer Schätzung, dasselbe Prinzip wie bei Frontend-Einträgen vor der Prototyp-Freigabe (6.8). Zählt erst wieder mit, sobald der Auftraggeber den Schnitt vorgenommen hat (Offene Punkte, Nr. 2).
...
| **Erste Fassung, Summe** | **83** | **357 h** |
| Zweite Fassung | 4 | 18 h |
| **Gesamt** | **87** | **375 h** |

**Nicht in dieser Summe enthalten:** R3-F-029 (Etappe 1), R3-Q-009 (Etappe 0) und R3-F-094 (zweite Fassung). Alle drei erfüllen die Definition of Ready nicht (R6, bei R3-F-029 zusätzlich R1, bei R3-F-094 zusätzlich R3) und tragen deshalb keinen Prüfaufwand; eine Schätzung vor Klärung wäre eine Vermutung (6.8). Sie zählen erst mit, sobald sie geschätzt sind.

**Sechste Nachführung am 2026-09-21**, in zwei Teilen. **Teil 1:** R3-Q-001 um den Stand-Vermerk zur am 2026-09-08 erteilten Abnahme des Prüfmittels ergänzt (Merge-Commit `9870b0d115b8ef330a7c19777af5741093e4f0e9`, Formweg 1 aus ADR 0002, Abschnitt 10; Teil 1 des Abnahmekriteriums erfüllt, Teil 2 nicht — getragen hat der in ADR 0002, 6.12.28 g vorab festgelegte Weg); ohne Auswirkung auf Summen, Etappenzuordnung oder Kano. **Teil 2:** R3-Q-010 (main-Gate und Prototyp-Gate, E4) neu in Etappe 0 eingeordnet und gegen die Definition of Ready geprüft (ready). R3-Q-010 ist trotz der nur zur Hälfte belegten R1 als ready geführt und in die Summen aufgenommen, weil der Stakeholder benannt und der Bezug begründet ist und die Abstimmung — anders als bei R3-Q-009, R3-F-029 und R3-F-094, deren Umfang oder Abnahmekriterium selbst offen ist — allein an der Freigabe durch den Auftraggeber hängt; dieselbe Lücke tragen R3-Q-001 bis R3-Q-009, die ebenfalls gezählt sind (offene Punkte 12 und 15). Der Eintrag ist ready mit diesem Vorbehalt und in der Summe geführt, wie R3-Q-001 bis R3-Q-009 (offene Punkte 12 und 15); `docs/06_Definition_of_Ready_und_Done.md` ist nicht fortgeschrieben. Kano von "Basisfaktor (Vorschlag)" auf "Basisfaktor" gesetzt, Prüfaufwand von 5 h bestätigt; Platzierung unmittelbar nach R3-Q-001 beibehalten. Etappe 0 steigt von 10 auf 11 Einträge und von 32 h auf 37 h; die Erste Fassung, Summe steigt von 82 auf 83 Einträge und von 352 h auf 357 h; das Gesamt steigt von 86 auf 87 Einträge und von 370 h auf 375 h. `docs/03_Glossar.md` ist um die Einträge "Gate" und "Hook" ergänzt (Requirements Engineer), weil R3-Q-010 beide Begriffe tragend verwendet (R3 der Definition of Ready). Neue offene Punkte angefügt — Nr. 19 (Lesart von R1 für Einträge mit benanntem Stakeholder; die Definition of Ready ist dafür nicht fortgeschrieben) und Nr. 18 (Freigabe des Umfangs von R3-Q-010 und Entscheid über den Schnitt E4.1 bis E4.3 durch den Auftraggeber). Nach der Prüfung hat der Requirements Engineer den Eintrag nachgeführt: `R3-Q-010_pruefmittel_je_gate` um den Regressionsschutz ergänzt, zwei Abnahmekriterien um die Zustandsaussage ergänzt und die Zähleinheit von `R3-Q-010_benannte_grenzen` abgezählt; Kano und Prüfaufwand unverändert bestätigt. Jede Zahl ist erneut gegen den tatsächlichen Dateiinhalt nachgerechnet, nicht fortgeschrieben.

**Vierte Nachführung am 2026-08-31** nach einer unabhängigen Prüfung des Backlog-Commits vom selben Tag (drei nicht blockierende Beobachtungen, ohne blockierenden Befund): R3-F-062 erhält eine Gegenprobe im bestehenden Abnahmekriterium (keine Auswirkung auf den Prüfaufwand); R3-F-094 wird auf Kano und Prüfaufwand offen gesetzt und aus der Summe der zweiten Fassung genommen, weil es dieselbe Nicht-ready-Begründung wie R3-Q-009 und R3-F-029 trägt, bisher aber anders verbucht war (zweite Fassung sinkt von 5 auf 4 Einträge und von 23 h auf 18 h, Gesamt von 87 auf 86 Einträge und von 375 h auf 370 h); R3-Q-007 erhält beim zweiten Abnahmekriterium eine am Bestand der 21 Rollendateien abgeleitete Konkretisierung, ohne Änderung an Kano oder Prüfaufwand. Jede Zahl ist erneut gegen den tatsächlichen Dateiinhalt nachgerechnet, nicht fortgeschrieben.
...
| 2 | Schnitt von R3-F-094; der Eintrag erfüllt die Definition of Ready nicht. Seit 2026-08-31 ohne Kano-Einordnung und ohne Prüfaufwand, aus der Summe der zweiten Fassung genommen (Angleichung an R3-Q-009 und R3-F-029) | Auftraggeber mit Product Owner |
| 3 | **Erledigt am 2026-08-20.** Bestätigung des Schnitts erste gegen zweite Fassung nach 9.1 — bestätigt als E-03 in `docs/08_Freigabe_Schritt_4.md` mit der pauschalen Freigabe; Änderungen gehen seither den regulären Weg über den Product Owner (DoR B4). Diese Zeile blieb fälschlich als offen stehen (Befund P-04 des Zustandsberichts vom 2026-09-02, `docs/10_Zustandsbericht_2026-09-02.md`) | erledigt, bestätigt durch den Auftraggeber am 2026-08-20 |
...
| 15 | R3-Q-007 bis R3-Q-009 und R3-F-029, R3-F-062 tragen ebenfalls keinen benannten Stakeholder (wie Punkt 12); dazu R3-Q-010 (Stakeholder S-01 und S-02 benannt, Abstimmung des Bedürfnisses offen, fällt für S-01 mit der Freigabe des Umfangs an); nachzuführen | Requirements Engineer mit Product Owner |
...
| 17 | R3-Q-007, zweites Abnahmekriterium: Backend Engineer, SecDevOps Engineer, DevOps Engineer und Docker- und Kubernetes/Portainer-Experte benennen ihre Schreibgrenze im Bestand vom 2026-08-31 ausschliesslich funktional (Zuständigkeitsabgrenzung), nicht über ein Verzeichnis oder einen Arbeitsprodukt-/Artefakttyp. Ob das für dieses Kriterium genügt oder die vier Rollentexte nachgeführt werden, entscheidet sich mit der Umsetzung | Requirements Engineer mit Software Architect |
| 18 | Freigabe des Umfangs von R3-Q-010 (main-Gate und Prototyp-Gate, E4) und Entscheid über den Schnitt E4.1 bis E4.3 (ADR 0002, 6.13) | Auftraggeber |
| 19 | Lesart von R1 für Einträge mit benanntem Stakeholder, deren Abstimmung erst mit der Freigabe durch den Auftraggeber eintritt (R3-Q-010; sinngemäss R3-Q-001 bis R3-Q-009): in `docs/06_Definition_of_Ready_und_Done.md` festhalten oder die Einträge aus der Summe nehmen | Requirements Engineer mit Product Owner, Bestätigung Auftraggeber |
