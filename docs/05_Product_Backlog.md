...
- **Nachweis:** Der ausgeführte Selbsttest `scripts/dod-gate-selbsttest.sh` (Stand 2026-09-03: 152 Zusicherungen `Z-nnn` der Tabelle ADR 0002, 6.12.19, Schlusszeilen "Selbsttest: 152 von 152 Zusicherungen bestanden" und "Deckung: 152 Kennungen in der Tabelle, 152 geprueft, 0 ohne Pruefung, 0 ohne Kennung") und die unabhängige Prüfung durch Static und Dynamic Software Tester, auf einem anderen Modell als die Umsetzung (3.4).
- **Stand 2026-09-03:** Entwurf als ADR 0002, 6.12 vorgelegt; Bau auf Weisung des Auftraggebers vom 2026-09-02; fünf Prüfrunden durch Static und Dynamic Software Tester auf einem anderen Modell, alle Befunde der Runden 1 bis 4 belegt behoben; O-24 vom Auftraggeber entschieden und als 6.12.25 umgesetzt (152 Zusicherungen, Deckung mechanisch in beide Richtungen); Runde 5 nach 3.4 abgebrochen, weil die Fehlerklasse "Selbsttestfall besteht, ohne seine Behauptung zu belegen" zum fünften Mal auftrat — 16 Zusicherungen messen einen anderen Kanal als genannt, eine stellt die verletzende Lage nicht her (ADR 0002, 6.12.25 k; `docs/uebergaben/2026-09-03_r3-q-001-o-24-zusicherungen.md`). Vorgelegt ist O-25 (Kanalspalte maschinell abgeglichen, Mutationsprobe je Zusicherung). Förmliche Freigabe der Entscheidpunkte E-A bis E-K und Abnahme stehen aus (ADR 0002, Abschnitt 10).
