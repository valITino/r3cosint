...
- **Nachweis:** Der ausgeführte Selbsttest `scripts/dod-gate-selbsttest.sh` (Stand 2026-09-03: 81 Fälle, Schlusszeile "Selbsttest: 81 von 81 Faellen bestanden") und die unabhängige Prüfung durch Static und Dynamic Software Tester, auf einem anderen Modell als die Umsetzung (3.4).
- **Stand 2026-09-03:** Entwurf als ADR 0002, 6.12 vorgelegt; Bau auf Weisung des Auftraggebers vom 2026-09-02; drei Prüfrunden durch Static und Dynamic Software Tester auf einem anderen Modell, alle Befunde der Runden 1 und 2 belegt behoben; am 2026-09-03 nach 3.4 abgebrochen, weil die Fehlerklasse "Selbsttestfall besteht, ohne seine Behauptung zu belegen" zum dritten Mal auftrat (ADR 0002, 6.12.24 j, O-24; `docs/uebergaben/2026-09-02_r3-q-001-gate-gebaut.md`). Förmliche Freigabe der Entscheidpunkte E-A bis E-K, Entscheid O-24 und Abnahme stehen aus (ADR 0002, Abschnitt 10).
