...
- **Offene Posten aus Runde 11 (Sammelposten unter diesem Eintrag, kein eigener Backlog-Eintrag; Sache der Einheit nach O-27):** blockierend nach 6.12.27 g DT11-01 bis DT11-05 (weitere Verstossformen der Markengrammatik), DT11-06 (`E21` nur an einer von drei Aufrufstellen gemessen), DT11-07 bis DT11-10 (`A08`, `A04`, `A05` an drei nie beschrittenen Blockpfaden); DT11-11 (dieselben drei Pfade und der Sperrpfad blockieren, ohne "Schluessel: " zu nennen — Befund am Original, kein falsches Grün); S11-04 bis S11-06 (Deckungen bestehen leer, wenn ihr Lesen misslingt); nachrangig S11-02, S11-03, S11-09, S11-10, S10-06, SST-B5-09, S9-05 (ADR 0002, 6.12.27 k und Abschnitt 9).
